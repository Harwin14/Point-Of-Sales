...
module.exports = (db) => {
    ...
    //         const { barcode } = req.params
    //       const { name, stock, purchaseprice, sellingprice, unit} = req.body
    //       await db.query('UPDATE goods SET name=$1, stock=$2, purchaseprice=$3, sellingprice=$4, unit=$5, picture=$6 WHERE barcode=$7', [  barcode, name, stock, purchaseprice, sellingprice, unit, imagesfiles])
